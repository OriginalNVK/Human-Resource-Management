...
GRANT SELECT ON QLDH_ADMIN TO LOGIN_ROLE;
GRANT SELECT ON QLDH_NHANVIEN TO LOGIN_ROLE;
GRANT SELECT ON QLDH_SINHVIEN TO LOGIN_ROLE;
GRANT RESTRICTED SESSION TO LOGIN_ROLE;
GRANT SELECT ON QLDH_DONVI TO LOGIN_ROLE;
GRANT UPDATE (DT) ON QLDH_NHANVIEN TO LOGIN_ROLE;
...
SELECT sub.MAMH, sub.MAHP, sub.MAGV, sub.HK,sub.NAM
...
GRANT SELECT ON QLDH_VIEW_COURSE_INFO_SV TO SV;
